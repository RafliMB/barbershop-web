<section id="layanan" class="layanan-section">
  <div class="layanan-wrapper">
    <h2 class="layanan-title">SERVICE DAN HARGA KAMI</h2>
    <p class="layanan-subtitle">Beragam service dengan kualitas dan harga terbaik untuk anda</p>

    <div class="layanan-grid">
      <!-- Haircut Service -->
      <div class="layanan-card">
        <h3>Haircut Service</h3>
        <h4>START IDR 50.000</h4>
      ...
      <div class="layanan-card">
        ...
        <ul>
          ...
          <li>Warna tahan lama dengan hasil tampak alami dan estetik</li>
        </ul>
        <button>Buat Janji Sekarang</button>
      </div>
